...
public class DeliveryStatusLayout extends ConstraintLayout {
    ...
    public DeliveryStatusLayout(Context context) {
        super(context);
    }

    public DeliveryStatusLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//            }else {
//                tips.setImageResource(R.mipmap.icon_remainingpicking_list);
//                main.setBackgroundResource(R.mipmap.bg_remaining_list);
//                unit.setImageResource(R.mipmap.icon_minute_remaining_list);
//            }
