...
public class MathUtils {
    ...
    public static double add(double v1, double v2) {
        return add(new BigDecimal(v1), new BigDecimal(v2)).setScale(2, BigDecimal.ROUND_HALF_DOWN)
                .doubleValue();
    }
    ...
    public static double subtract(double v1, double v2) {
        return subtract(new BigDecimal(v1), new BigDecimal(v2)).setScale(2, BigDecimal.ROUND_HALF_DOWN)
                .doubleValue();
    }
    ...
    public static double multiply(double v1, double v2) {
        return multiply(new BigDecimal(v1), new BigDecimal(v2)).setScale(2, BigDecimal.ROUND_HALF_DOWN)
                .doubleValue();
    }
     ...
     * @return 两个参数的积(String)
     */
    public static String multiplyInt(String v1, String v2) {
        if (isBlank(v1)) {
            v1 = "1";
        }
        if (isBlank(v2)) {
        ...
        BigDecimal b1 = new BigDecimal(v1.trim());
        BigDecimal b2 = new BigDecimal(v2.trim());
        return String.valueOf(multiply(b1, b2).intValue());
    }
     ...
     * @return 两个参数的积(String)
     */
    public static double multiply(double v1, String v2) {
        if (isBlank(v2)) {
            v2 = "1";
        }
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2.trim());
        return multiply(b1, b2).setScale(2, BigDecimal.ROUND_HALF_DOWN)
                .doubleValue();
    }
    ...
    public static double divide(double v1, double v2) {
        return divide(new BigDecimal(v1), new BigDecimal(v2)).setScale(DEF_DIV_SCALE, BigDecimal.ROUND_HALF_UP).doubleValue();
    }

    /**
     * ( 相对 )精确除法运算 , 当发生除不尽情况时 , 精确到 小数点以后2位 , 以后数字直接抹掉
     *
     * @param v1 被除数
     * @param v2 除数
     * @return 两个参数的商(String)
     */
    public static String divideDown(String v1, String v2) {
        if (null == v1) {
            return "0";
        }
        if (null == v2) {
        ...
        BigDecimal b1 = new BigDecimal(v1.trim());
        BigDecimal b2 = new BigDecimal(v2.trim());
        return String.valueOf(divide(new BigDecimal(v1), new BigDecimal(v2)).setScale(DEF_DIV_SCALE, BigDecimal.ROUND_DOWN).doubleValue());
    }
    ...
    public static double divide(double v1, double v2, int scale) {
        return divide(new BigDecimal(v1), new BigDecimal(v2), scale).setScale(scale, BigDecimal.ROUND_HALF_UP).doubleValue();
    }
    ...
    public static double roundDouble(double f) {
